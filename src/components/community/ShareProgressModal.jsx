              ...
              <div className="grid grid-cols-3 gap-2">
                {categories.map(cat => (
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 text-sm transition-all ${selectedCategory === cat.value
              ...
              <div className="grid grid-cols-2 gap-2">
                {progressTypes.map(type => (
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 text-left transition-all ${progressType === type.value
                      ? 'border-purple-500 bg-purple-50'
                      : 'border-gray-200 hover:border-purple-300'
                      }`}
                  >
              ...
              <div className="flex gap-2 flex-wrap">
                {moodEmojis.map(emoji => (
                  <button
                    ...
                    className={`text-3xl p-2 rounded-lg transition-all ${moodEmoji === emoji
